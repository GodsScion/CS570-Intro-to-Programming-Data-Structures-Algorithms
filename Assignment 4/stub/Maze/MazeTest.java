...
public class MazeTest extends JFrame implements GridColors {
 ...
 //       Blob aBlob = new Blob(aGrid);
    ...
    public void solve() {
        ...
        for (int k=0; k<m.findAllMazePaths(0,0).size();k++) {
        	System.out.println("Maze path"+k+m.findAllMazePaths(0,0).get(k));
        }
        System.out.println("Shortest Maze path"+m.findMazePathMin(0,0));
